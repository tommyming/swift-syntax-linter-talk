...
// This is example code to demonstrate the linting rules

// Example 1: A class that might be too large (for testing LargeClassRule)
...
// Example 2: Functions with too many parameters (for testing TooManyParametersRule)
...
// Example 3: A reasonably sized class (should not trigger LargeClassRule)
